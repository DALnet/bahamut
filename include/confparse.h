...
#define OPTF_SASLSERVICE     "SASLSERVICE"
#define OPTF_SASLSERVICE_FLAG 0x004000

#define OPTT_SASLTIMEOUT "SASL_TIMEOUT"
#define OPTF_SASLTIMEOUT          0x800000

#define OPTT_SASLRATELIMIT "SASL_RATELIMIT"
#define OPTF_SASLRATELIMIT          0x1000000
...
sConf confopttab[] =
{
    ...
    {OPTT_SASLTIMEOUT, OPTF_SASLTIMEOUT, VARTYPE_INT},
    {OPTT_SASLRATELIMIT, OPTF_SASLRATELIMIT, VARTYPE_NAME},
    {(char *) 0, 0, 0}
};
