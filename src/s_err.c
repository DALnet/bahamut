...
static char *replies[] = 
{
    ...
    /* 213 RPL_STATSCLINE */	":%s 213 %s %s %s * %s %d %d",
    /* 214 RPL_STATSNLINE */	":%s 214 %s %s %s * %s %d %d",
    /* 215 RPL_STATSILINE */	":%s 215 %s %s %s * %s %d %d",
    ...
    /* 243 RPL_STATSOLINE */	":%s 243 %s %s %s * %s %lu %d",
    /* 244 RPL_STATSHLINE */	":%s 244 %s %s %s * %s %d %d",
