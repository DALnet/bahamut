...
static char *replies[] = 
{
    ...
    /* 004 RPL_MYINFO */	":%s 004 %s %s %s aAbBcCdefFghHiIjkKmnoOPrRsSwxXy "
    ...
    /* 492 */	                NULL,
    /* 493 ERR_NOSHAREDCHAN */	":%s 493 %s %s :You cannot message that person because you do not share a common channel with them.",
    ...
    /* 668 */	                NULL,
    /* 669 */	                NULL,
    /* 670 RPL_STARTTLS */	":%s 670 %s :STARTTLS successful",
    /* 671 */	                NULL,
    /* 672 */	                NULL,
    /* 673 */	                NULL,
    /* 674 */	                NULL,
    ...
    /* 689 */	                NULL,
    /* 690 */	                NULL,
    /* 691 ERR_STARTTLS */	":%s 691 %s :STARTTLS failed",
    /* 692 */	                NULL,
    /* 693 */	                NULL,
    /* 694 */	                NULL,
    /* 695 */	                NULL,
    ...
    /* 907 ERR_SASLALREADY */ ":%s 907 %s :You have already authenticated via SASL",
    /* 908 RPL_SASLMECHS */   ":%s 908 %s PLAIN :are available SASL mechanisms",
    /* 909 */	                NULL,
    /* 910 */	                NULL,
    /* 911 */	                NULL,
    /* 912 */	                NULL,
