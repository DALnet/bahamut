...
static char *replies[] = {
	...
	/* 004 RPL_MYINFO */	":%s 004 %s %s %s oiwszcrkfydaAbg biklmnoprRstv",
	/* 005 RPL_PROTOCTL*/ ":%s 005 %s NOQUIT TOKEN WATCH=128 SAFELIST :are available on this server",
	/* 006 */	NULL,
	/* 007 */	NULL,
	/* 008 */	NULL,
	/* 009 */	NULL,
...
# ifdef HIGHEST_CONNECTION
	...
	/* 263 */			":%s 263 %s :Server load is temporarily too heavy. Please wait a while and try again.",
	/* 264 */	NULL,
...
char *err_str(int numeric) { return getreply(numeric); 
}
char *rpl_str(int numeric) { return getreply(numeric);
}
