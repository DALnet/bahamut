...
void
report_matching_host_klines(aClient *cptr, char *host)
{
   char       *pass;
   char       *name = (char *) NULL;
...
void
add_temp_kline(aConfItem *aconf)
{
