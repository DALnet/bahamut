...
static int m_rwho(struct MsgBuf *, aClient *, aClient *, int, char **);

static const struct mapi_cmd_av2 rwho_cmds[] = {
    { "RWHO", 0, {
        { mg_unreg, 0 }, { m_rwho, 0 }, { m_rwho, 0 },
        { m_rwho,   0 }, { m_rwho, 0 } }},
    { NULL }
};

DECLARE_MODULE("m_rwho", "2.0", "Regex WHO", 0, rwho_cmds, NULL);
 ...
 * parv[2] - arguments
 */
static int m_rwho(struct MsgBuf *msgbuf, aClient *cptr, aClient *sptr, int parc, char *parv[])
{
    chanMember *cm;
    aClient    *ac;
